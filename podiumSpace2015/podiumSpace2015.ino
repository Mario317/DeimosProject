...
const int pinBoton1 = 0;            // Pin Push Button 1
const int pinBoton2 = 1;            // Pin Push Button 2
...
void leerMapearAcelerometrosGiroscopios() {
  ...
  ax1 = map(ax1, -32768, 32767, 0, 20);
  ay1 = map(ay1, -32768, 32767, 0, 20);
  az1 = map(az1, -32768, 32767, 0, 20);
  gx1 = map(gx1, -32768, 32767, 0, 20);
  gy1 = map(gy1, -32768, 32767, 0, 20);
  gz1 = map(gz1, -32768, 32767, 0, 20);
